        ...
        $(window).on('scroll', function () {
                if($(window).scrollTop() >= 85 ){
                    if ($("#slider1.dk").length > 0) {
                       ...
                       $('.navbar-brand img').attr('src', 'jelly/theone/mansonv2/assets/images/demo/logos/logo-slider-black.png'); 
                    }
                    
                }else{
                     if($(window).width()<1025){
                         if ($("#slider1.dk").length > 0) {
                             $('.navbar-brand img').attr('src', 'jelly/theone/mansonv2/assets/images/demo/logos/logo-slider-white.png');
                         }else{
                            $('.navbar-brand img').attr('src', 'jelly/theone/mansonv2/assets/images/demo/logos/logo-slider-black.png');
                        }
                    }else{
